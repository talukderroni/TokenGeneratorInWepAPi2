...
export class AppComponent 
{
  ...
  public generateToken() 
  {
   ...
   return this.http.get<any>('http://localhost:63503/api/LoginPage/GetLoginInfo')
   .subscribe
    (result=>
      {
        console.log(result);
  ...
  public validToken() 
  {
   ...
   return this.http.post<any>('http://localhost:63503/api/LoginPage/GetName',{}, { 'headers': headers })
     .subscribe
     (
        result=>
        {
